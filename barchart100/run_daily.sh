#!/usr/bin/env bash
# Daily runner for the Barchart Top 100 dashboard.
#
...
#
# Or as a macOS launchd job — see com.barchart100.daily.plist (sibling file).
set -euo pipefail
...
{
  echo "=========================================="
  echo "Barchart Top 100 daily run — $(date)"
  echo "=========================================="
  ...
  # Use the user's preferred python3; fall back to system.
  PY="${PYTHON:-python3}"
