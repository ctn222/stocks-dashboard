#!/usr/bin/env bash
# Daily runner for the Webull Options Total Volume 100 dashboard.
#
...
#
# Or as a macOS launchd job — see com.topoptions.daily.plist (sibling file).
set -euo pipefail
...
{
  echo "=========================================="
  echo "Webull Options Total Volume 100 daily run — $(date)"
  echo "=========================================="
